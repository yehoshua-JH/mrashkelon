...
export default function BrizaPenthouse() {
  return (
    <div className="min-h-screen" style={{ backgroundColor: "oklch(1 0 0)" }}>
      ...
      >
        {/* SOLD banner — top right */}
        <div
          className="absolute top-20 right-4 sm:right-8 z-20 px-5 py-2 font-bold tracking-widest text-sm uppercase"
          style={{ backgroundColor: "#c0392b", color: "#ffffff", letterSpacing: "0.15em" }}
        >
          SOLD
        </div>
        ...
        <div className="relative z-10 px-4 sm:px-6 md:px-12 pb-8 pt-8">
          ...
          >
            Floor 22 — Open sea views — 70 m² terrace.
          </p>

          {/* SOLD notice + contact CTA */}
          <div className="flex flex-col sm:flex-row gap-3">
            <div
              className="inline-flex items-center gap-2 px-6 py-4 font-bold text-base"
              style={{ backgroundColor: "#c0392b", color: "#ffffff", borderRadius: "4px" }}
            >
              This property has been SOLD
            </div>
            <a
              href="/contact"
              className="inline-flex items-center gap-2 px-6 py-4 font-semibold text-base transition-all duration-200"
              style={{ backgroundColor: "oklch(0.35 0.06 200)", color: "#ffffff", borderRadius: "4px" }}
            >
      ...
      >
        <div className="container max-w-xl mx-auto">
          <div className="inline-block px-4 py-1 mb-4 text-sm font-bold tracking-widest uppercase" style={{ backgroundColor: "#c0392b", color: "#fff" }}>SOLD</div>
          <h2
          ...
          >
            Looking for something similar? Contact Motti — we may have comparable properties available.
          </p>
          <a
      ...
      <ContactForm
        ...
        subtitle="This property has been sold. Fill in the form below and Motti will get back to you about similar available properties."
      />
