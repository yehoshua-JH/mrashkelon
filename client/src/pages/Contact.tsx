...
// Layout: Contact info cards on top row, form below — fully visible at all screen sizes
// =============================================================
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="py-16 md:py-24 flex-1">
        <div className="container px-4 max-w-4xl mx-auto">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <a
                  ...
                  className="font-medium text-foreground hover:text-secondary transition-colors break-all"
                >
          ...
          {/* Contact Form — full width, always visible */}
          {submitted ? (
            <div className="flex flex-col items-center justify-center py-16 text-center bg-accent/5 rounded-xl border border-border">
