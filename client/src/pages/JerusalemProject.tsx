  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: "oklch(1 0 0)" }}>
      ...
      >
        ...
        <div className="relative z-10 px-6 md:px-12 pb-8 pt-8">
          {/* Location badge — inside content flow to avoid overlap */}
          <div className="mb-6">
            <div
      ...
      >
        <div className="container">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5 max-w-4xl mx-auto">
